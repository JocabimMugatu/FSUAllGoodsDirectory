...
function CatalogCardComponent({ item }: CatalogCardProps) {
  ...
  return (
    <Link
      to={`/item/${item.id}`}
      className="group block h-full transform transition will-change-transform hover:-translate-y-1"
    >
        ...
        <CardHeader className="space-y-4 p-4 pb-0">
          ...
          <div className="flex items-start justify-between gap-2">
            <div className="min-w-0">
              ...
              <CardDescription className="text-sm capitalize">{item.category}</CardDescription>
            </div>
